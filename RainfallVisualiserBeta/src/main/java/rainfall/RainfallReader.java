...
public class RainfallReader {
     ...
     */
    public static void CSVReadData(RainfallProcessData csvTempFile, String fileName) {
        try {
     ...
     */
    public static void loadProcessedData(RainfallProcessData csvTempFile, double[] monthlyTotal, double[] dailyMin, double[] dailyMax) {
        for (int i = 0; i < 12; i++) {
